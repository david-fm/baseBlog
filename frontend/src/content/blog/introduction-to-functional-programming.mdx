...
- functions which returns undeterming values because of inputs that can vary its values in the middle of execution or... 
...
Bear in mind the previous python example is not pure Functional Programming, it tries to express a point for the functional programming in an comprehensible way.
...
https://youtu.be/3n17wHe5wEw?feature=shared
